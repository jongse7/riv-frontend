  ...
  return (
    <NavigationMenu className="relative z-10">
      <NavigationMenuList className="flex space-x-2">
        <NavigationMenuItem>
          <NavigationMenuTrigger className="font-medium group text-gray-09 flex items-center space-x-1 px-[0.5rem] py-[0.3rem] rounded-full bg-[#1E1F22] hover:text-gray-07">
